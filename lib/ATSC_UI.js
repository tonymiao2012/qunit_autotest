...
function onMenuKeyEnter() {
    ...
    var repeat, expectNum, otherValue;
    if(toolbarArray[0] !== undefined)
        repeat = parseInt(toolbarArray[0].value) || 1;
    else
        repeat = 1;
    if(toolbarArray[1] !== undefined)
        expectNum = parseInt(toolbarArray[1].value) || 0;
    else
        expectNum = 0;
    if(toolbarArray[2] !== undefined)
        otherValue = parseInt(toolbarArray[2].value) || 0;
    else
        otherValue = 0;
    ...
    switch (testType) {
        case '1':
            handleRepeatTestCase(repeat, expectNum, funcName);
            break;
        case '2':
            handleScanTestCase(expectNum, otherValue, funcName);
            break;
        case '3':
            handlePlayTestCase(otherValue, funcName);
            break;
        case '4':
            handleServiceListTestCase(expectNum, otherValue, funcName);
            break;
        case '5':
            handlePCTestCase(expectNum, otherValue, funcName);
            break;
        case '6':
            handleCCTestCase(expectNum, otherValue, funcName);
            break;
        case '7':
            handleInfoBarTestCase(expectNum, otherValue, funcName);
            break;
    }
