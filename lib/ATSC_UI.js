...
function fileHandler() {
    ...
    this.writeFileToNative = function (path, content, workRoot) {
        ...
        try {
            ret = Hisense.File.Append(path, content, workRoot);
            if (ret != 0) {
...
function onMenuKeyEnter() {
    ...
    switch (testType) {
        case '1':
            handleRepeatTestCase(toolbarArray, funcName);
            break;
        case '2':
            handleScanTestCase(toolbarArray, funcName);
            break;
        case '3':
            handlePlayTestCase(toolbarArray, funcName);
            break;
        case '4':
            handleServiceListTestCase(toolbarArray, funcName);
            break;
        case '5':
            handlePCTestCase(toolbarArray, funcName);
            break;
        case '6':
            handleCCTestCase(toolbarArray, funcName);
            break;
        case '7':
            handleInfoBarTestCase(toolbarArray, funcName);
            break;
        case '8':
            handleAutoTestCase(toolbarArray, funcName);
            break;
    }
