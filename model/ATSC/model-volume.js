...
{
    VolumeModelDefines.SL2_TVAPI_VOLUME_TABLE_MAIN = "de.loewe.sl2.volume.table.main";
    VolumeModelDefines.SL2_TVAPI_VOLUME_VSTR_LATEST_EVENT = "de.loewe.sl2.volume.vstr.latest.event";
    ...
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_SYSTEM = 1;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_SEALED_BOX = 2;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_EXTERNAL = 4;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_GENUINE = 8;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_VIA_NETWORK = 16;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_VIA_LOGICAL_FS = 32;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_UPDATE_SOURCE = 256;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_PVR_ARCHIVE = 512;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_PVR_TIMESHIFT = 1024;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_MEDIA_SOURCE = 4096;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_MEDIA_STORAGE = 8192;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_IMAGES = 65536;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_MUSIC = 131072;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_VIDEOS = 262144;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_BROWSABLE = 1048576;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_SEARCHABLE = 2097152;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_EXTERNALLY_LAYOUTED = 4194304;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_PVR_SEARCHABLE = 8388608;
    VolumeModelDefines.ENUM_SL2_TVAPI_VOLUME_PURPOSE_ALL_CURRENT = 16201535;
    ...
    VolumeModelDefines.SL2_TVAPI_VOLUME_FSAL2_MEDIA_TYPE_UPNP = 2;
...
function VolumeModel(_) {
    SubModel.call(this, _, VolumeModelDefines);
    this.registerSubObject = function (loadType) {

        this.registerTableObject(VolumeModelDefines.SL2_TVAPI_VOLUME_TABLE_MAIN, "createTableMainIterator");
        this.registerStringVectorObject(VolumeModelDefines.SL2_TVAPI_VOLUME_VSTR_LATEST_EVENT, "getVstrLatestEvent", "setVstrLatestEvent", "onVstrLatestEventChaged", null, null)
...
{
    SubModel.registerStaticConstants(VolumeModel, VolumeModelDefines, [])
}
