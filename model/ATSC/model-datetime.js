...
{
    DatetimeModelDefines.SL2_TVAPI_STR_DATETIME_TIME_ZONE = "de.loewe.sl2.i32.datetime.timezone.id";
    DatetimeModelDefines.SL2_TVAPI_I32_DATETIME_TIME_FORMAT = "de.loewe.sl2.i32.datetime.format";
    DatetimeModelDefines.SL2_TVAPI_I64_DATETIME_BROADCAST_TIME = "de.loewe.sl2.i64.datetime.time.utc";
...
function DatetimeModel(e) {
    ...
    this.registerSubObject = function () {
        ...
        // this.registerIntegerObject(
        //     Timer_functionsModelDefines.SL2_TVAPI_I64_DATETIME_TIME_UPTIMEOFFSET,//
